...
public class TableInfo extends BaseEntity {
	...
	private boolean packageContainClassname = false;
	...
	public boolean isPackageContainClassname() {
		return packageContainClassname;
	}

	public void setPackageContainClassname(boolean packageContainClassname) {
		this.packageContainClassname = packageContainClassname;
	}
