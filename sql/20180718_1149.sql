...
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler','DESKTOP-7GM7M6V1531885212810',1531885770504,15000);
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=480 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_online` VALUES ('2746ca00-7000-4987-8409-dd1fb52cac61','admin','研发一部','127.0.0.1','','Chrome','Windows 10','on_line','2018-07-18 11:38:21','2018-07-18 11:38:23',1800000);
...
-- Dump completed on 2018-07-18 11:49:32
