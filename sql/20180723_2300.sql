...
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler','huangzhenhuideMacBook-Pro.local1532357164603',1532357890491,15000);
...
CREATE TABLE `sys_address_city` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='城市';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_address_city` VALUES (1,'福州',2,0,'2018-07-07 00:28:06','admin','2018-07-07 00:28:25','admin','2'),(2,'厦门',2,0,'2018-07-07 00:28:17','admin','2018-07-07 00:28:17',' ','22'),(3,'福州市1133',4,0,'2018-07-08 12:20:26','admin','2018-07-08 12:33:15','admin','22a'),(4,'福州市2',6,0,'2018-07-08 13:38:12','admin','2018-07-08 13:38:28','admin','3'),(5,'111',4,0,'2018-07-23 21:41:31','admin','2018-07-23 21:41:31',' ',' ');
...
CREATE TABLE `sys_address_country` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='国家';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_address_country` VALUES (2,'中国','86','CN','0','','2018-07-02 16:44:39','','2018-07-02 16:44:39','dfdsfa'),(4,'美国','11','USA','0','','2018-07-02 17:11:34','','2018-07-02 17:11:34','dfa'),(5,'美国','86','USA','0','admin','2018-07-02 17:17:10','admin','2018-07-02 17:17:10','dfaszzzzz'),(6,'ffd','455','sfg','1','admin','2018-07-07 21:20:00','admin','2018-07-07 21:20:00',''),(7,'ffd','11','222','0','admin','2018-07-23 21:50:16','','2018-07-23 21:50:16','');
...
INSERT INTO `sys_address_fulladdress` VALUES (1,2,2,'晋安区','350800',0,'2018-07-07 00:28:45',' ','2018-07-08 13:52:54','admin','1'),(3,4,3,'1123','3232',0,'2018-07-08 13:25:14','admin','2018-07-08 13:25:14',' ','3211'),(5,2,1,'dfa','aaaa',0,'2018-07-23 21:51:36','admin','2018-07-23 21:51:36',' ',' ');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2090 DEFAULT CHARSET=utf8 COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=719 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sys_personal_profile`
--

DROP TABLE IF EXISTS `sys_personal_profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sys_personal_profile` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `country_id` int(11) NOT NULL COMMENT '国家',
  `country_title` varchar(45) DEFAULT '' COMMENT '国家',
  `city_id` int(11) NOT NULL,
  `city_title` varchar(45) DEFAULT '' COMMENT '城市',
  `address_id` int(11) NOT NULL,
  `address_title` varchar(255) DEFAULT '' COMMENT '地址',
  `province` varchar(255) DEFAULT NULL COMMENT '省份',
  `holder` varchar(45) DEFAULT NULL COMMENT '持有者',
  `user_name` varchar(45) DEFAULT NULL COMMENT '用户名称',
  `password` varchar(45) DEFAULT NULL COMMENT '密码',
  `gender` int(11) DEFAULT NULL COMMENT '性别',
  `birthday` date DEFAULT NULL,
  `profile_type` int(11) DEFAULT NULL COMMENT '信息类型',
  `profile_status` int(11) DEFAULT '1' COMMENT '可用状态 1.可用 2.不可用',
  `importance` int(11) DEFAULT '1' COMMENT '重要性 1.主要的 2.其次的 3.合格的',
  `create_by` varchar(45) DEFAULT '',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_by` varchar(45) DEFAULT '',
  `update_time` datetime DEFAULT NULL,
...
--
-- Dumping data for table `sys_personal_profile`
--

LOCK TABLES `sys_personal_profile` WRITE;
/*!40000 ALTER TABLE `sys_personal_profile` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_personal_profile` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_role` VALUES (1,'管理员','admin',1,'0','admin','2018-03-16 11:33:00','admin','2018-07-23 22:52:33','管理员'),(2,'普通角色','common',2,'0','admin','2018-03-16 11:33:00','ry','2018-03-16 11:33:00','普通角色');
...
INSERT INTO `sys_user_online` VALUES ('518ef5b0-5d97-48f4-ba64-26db9057b3b3','admin','研发一部','127.0.0.1','','Chrome','Mac OS X','on_line','2018-07-23 22:46:20','2018-07-23 22:57:42',1800000);
...
-- Dump completed on 2018-07-23 23:00:03
